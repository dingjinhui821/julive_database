...
set spark.app.name=fact_city_channel_day_agg_indi;  
...
with tmp_clue_city_channel_day as (
...
tmp_distinct_city_channel_day as (
...
tmp_see_project_city_channel_day as (
...
tmp_see_project_emp_city_channel_day as (
...
tmp_subscribe_city_channel_day as (
...
tmp_subscribe_emp_city_channel_day as (
...
tmp_back_subscribe_city_channel_day as (
...
tmp_back_subscribe_emp_city_channel_day as (
...
tmp_sign_emp_city_channel_day as (
...
-- 城市-渠道-天指标表 
insert overwrite table julive_fact.fact_city_channel_day_agg_base_indi 
...
coalesce(t1.from_source,t2.from_source,t3.from_source,t4.from_source,t6.from_source,t7.from_source,t10.from_source,t11.from_source,t12.from_source,t13.from_source) as from_source,

current_timestamp() as etl_time 

from tmp_clue_city_channel_day t1 -- 线索/上户 
full join tmp_see_project_city_channel_day t2 on t1.date_str = t2.date_str and t1.city_id = t2.city_id and t1.channel_id = t2.channel_id and t1.from_source =t2.from_source and t1.org_id=t2.org_id
full join tmp_subscribe_city_channel_day t3 on t1.date_str = t3.date_str and t1.city_id = t3.city_id and t1.channel_id = t3.channel_id and t1.from_source =t3.from_source and t1.org_id=t3.org_id
full join tmp_sign_city_channel_day t4 on t1.date_str = t4.date_str and t1.city_id = t4.city_id and t1.channel_id = t4.channel_id and t1.from_source =t4.from_source and t1.org_id=t4.org_id
full join tmp_back_subscribe_city_channel_day t6 on t1.date_str = t6.date_str and t1.city_id = t6.city_id and t1.channel_id = t6.channel_id and t1.from_source =t6.from_source and t1.org_id=t6.org_id
full join tmp_distinct_city_channel_day t7 on t1.date_str = t7.date_str and t1.city_id = t7.city_id and t1.channel_id = t7.channel_id and t1.from_source =t7.from_source and t1.org_id=t7.org_id

full join tmp_see_project_emp_city_channel_day t10 on t1.date_str = t10.date_str and t1.city_id = t10.emp_city_id and t1.channel_id = t10.channel_id and t1.from_source =t10.from_source and t1.org_id=t10.org_id
full join tmp_subscribe_emp_city_channel_day t11 on t1.date_str = t11.date_str and t1.city_id = t11.emp_city_id and t1.channel_id = t11.channel_id and t1.from_source =t11.from_source and t1.org_id=t11.org_id
full join tmp_sign_emp_city_channel_day t12 on t1.date_str = t12.date_str and t1.city_id = t12.emp_city_id and t1.channel_id = t12.channel_id and t1.from_source =t12.from_source and t1.org_id=t12.org_id
full join tmp_back_subscribe_emp_city_channel_day t13 on t1.date_str = t13.date_str and t1.city_id = t13.emp_city_id and t1.channel_id = t13.channel_id and t1.from_source =t13.from_source and t1.org_id=t13.org_id
...
insert overwrite table julive_fact.fact_city_channel_day_agg_indi 
select * from julive_fact.fact_city_channel_day_agg_base_indi
where from_source =1;

insert overwrite table julive_fact.fact_wlmq_city_channel_day_agg_indi 
select * from julive_fact.fact_city_channel_day_agg_base_indi
where from_source =2;

insert overwrite table julive_fact.fact_esf_city_channel_day_agg_indi 
select * from julive_fact.fact_city_channel_day_agg_base_indi
where from_source =3;

insert overwrite table julive_fact.fact_jms_city_channel_day_agg_indi 
select * from julive_fact.fact_city_channel_day_agg_base_indi
where from_source =4;

insert into table julive_fact.fact_jms_city_channel_day_agg_indi 
select * from julive_fact.fact_city_channel_day_agg_base_indi
