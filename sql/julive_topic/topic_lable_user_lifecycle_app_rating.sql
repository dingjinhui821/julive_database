...
set spark.app.name=topic_lable_user_lifecycle_app_rating;
set spark.yarn.queue=etl;

insert overwrite table julive_topic.topic_lable_user_lifecycle_app_rating
select
tmp.global_id,
...
tmp.comjia_unique_id_valid_status,
tmp.comjia_unique_id_valid_status_update_datetime,
...
t1.comjia_unique_id                   as comjia_unique_id,
...
max(t1.manufacturer)                  as manufacturer,
max(t1.app_version)                   as app_version,
max(t1.os_system)                     as os_system,
max(t1.os_version)                    as os_version,                     
max(t1.is_close)                      as is_close,
max(t1.latest_distribute_date)        as latest_distribute_date,
max(t1.comjia_unique_id_valid_status) as comjia_unique_id_valid_status,
max(t1.comjia_unique_id_valid_status_update_datetime) as comjia_unique_id_valid_status_update_datetime,
...
t.product_id,       
t.comjia_unique_id, 
t.comjia_unique_id_valid_status,
t.comjia_unique_id_valid_status_update_datetime,
t.julive_id,
t.user_name,  
t.user_mobile,        
t.ip_city,          
...
if(t.investment_cnt>0,2.0,0) as investment_cnt_rating 
 ...
 where product_id in(101,201))t1
group by t1.global_id,t1.comjia_unique_id)tmp;
