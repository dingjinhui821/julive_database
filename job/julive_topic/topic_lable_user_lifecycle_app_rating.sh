...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_topic/topic_lable_user_lifecycle_app_rating.sql"
logFile="/data4/nfsdata/logs/etl/julive_topic/topic_lable_user_lifecycle_app_rating${sep}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/julive_dw/script/python/market_alert_dd.py -m "@15738713772: etl表(topic_lable_user_lifecycle_app_rating)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
