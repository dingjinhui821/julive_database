...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_app/app_feed_channelput_conversion.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_app/app_feed_channelput_conversion${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@13971279523: etl表(app_feed_channelput_conversion)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
