...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_app/app_esf_house_pv.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_app/app_esf_house_pv${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15738713772: etl表(app_esf_house_pv)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
