...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_app/app_market_app_process.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_app/app_market_app_process${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15996981324: etl表(app_market_app_process)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
