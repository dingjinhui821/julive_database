...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_app/app_market_plan_area_zhuanhua.hql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_app/app_market_plan_area_zhuanhua${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@18612857267: etl表(app_market_plan_area_zhuanhua)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
