...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_app/app_market_sem_process_yw.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_app/app_market_sem_process_yw${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@18600505375: etl表(app_market_sem_process_yw)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
