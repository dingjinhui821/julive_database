...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_app/app_depreciate_project.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_app/app_depreciate_project${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15738713772: etl表(app_depreciate_project)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
