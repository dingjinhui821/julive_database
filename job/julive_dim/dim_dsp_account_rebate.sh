...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_dim/dim_dsp_account_rebate.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_dim/dim_dsp_account_rebate${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15996981324: etl表(dim_dsp_account_rebate)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
