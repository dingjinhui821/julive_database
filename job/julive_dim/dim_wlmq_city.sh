...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_dim/dim_wlmq_city.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_dim/dim_wlmq_city${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15738713772: etl表(dim_wlmq_city)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
