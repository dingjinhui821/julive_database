...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_dim/dim_clue_ext_base.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_dim/dim_clue_ext_base${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15996981324: etl表(dim_clue_ext_base)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
