...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_dim/dim_dsp_account.hql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_dim/dim_dsp_account${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@18612857267: etl表(dim_dsp_account)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
