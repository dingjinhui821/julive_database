...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_topic/topic_dwt_order_base.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_topic/topic_dwt_order_base${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15996981324: etl表(topic_dwt_order_base)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
