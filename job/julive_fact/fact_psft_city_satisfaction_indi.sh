...
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_psft_city_satisfaction_indi${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15738713772: etl表(fact_psft_city_satisfaction_indi)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
