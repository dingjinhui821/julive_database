...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_fact/fact_android_app_store_cost_indi.hql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_android_app_store_cost_indi${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@18612857267: etl表(fact_android_app_store_cost_indi)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
