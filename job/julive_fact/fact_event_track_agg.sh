...
logFile="/data4/nfsdata/logs/etl/julive_fact/fact_event_track_agg${sep}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15738713772: etl表(fact_event_track_agg)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
