 ...
 #配置告警信息：任务别名，执行用户(etl/bi/dm)，钉钉注册电话号码
 monitorTaskName="fact_mgr_adjust_perf_indi"
 monitorGroup="etl"
 monitorPhone="157387137720"
 ...
 logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_mgr_adjust_perf_indi${pre}_${dateID}.log"
