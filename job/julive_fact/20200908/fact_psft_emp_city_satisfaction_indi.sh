...
monitorTaskName="fact_psft_emp_city_satisfaction_indi"
monitorGroup="etl"
...
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_psft_emp_city_satisfaction_indi${pre}_${dateID}.log"
