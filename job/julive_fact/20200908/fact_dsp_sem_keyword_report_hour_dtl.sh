...
monitorTaskName="fact_dsp_sem_keyword_report_hour_dtl"
monitorGroup="etl"
...
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_dsp_sem_keyword_report_hour_dtl${pre}_${dateID}.log"
