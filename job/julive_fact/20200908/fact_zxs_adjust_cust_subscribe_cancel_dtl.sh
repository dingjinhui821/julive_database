...
monitorTaskName="fact_zxs_adjust_cust_subscribe_cancel_dtl"
monitorGroup="etl"
...
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_zxs_adjust_cust_subscribe_cancel_dtl${pre}_${dateID}.log"
