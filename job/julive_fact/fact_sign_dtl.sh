...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_fact/fact_sign_dtl.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_sign_dtl${pre}_${dateID}_${RANDOM}.log"
