...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_fact/fact_market_appstore_city_share.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_fact/fact_market_appstore_city_share${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@15996981324: etl表(fact_market_appstore_city_share)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
