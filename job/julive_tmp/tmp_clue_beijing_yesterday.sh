...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_tmp/tmp_clue_beijing_yesterday.sql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_tmp/tmp_clue_beijing_yesterday${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@13971279523: etl表(tmp_clue_beijing_yesterday)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
