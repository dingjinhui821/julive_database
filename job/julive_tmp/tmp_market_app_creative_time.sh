...
sqlFile="/data4/nfsdata/julive_dw/etl/sql/julive_tmp/tmp_market_app_creative_time.hql"
logFile="/data4/nfsdata/julive_dw/etl/logs/julive_tmp/tmp_market_app_creative_time${pre}_${dateID}_${RANDOM}.log"
...
python /data4/nfsdata/dingtalk_monitor/monitor/azkaban_responder.py -m "@18612857267: etl表(tmp_market_app_creative_time)ETL发生异常，请尽快处理!"
eeooff
    exit $EXCODE
fi
