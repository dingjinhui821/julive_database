drop table if exists julive_app.app_emp_city_project_first_seetype_day_base;
CREATE TABLE julive_app.app_emp_city_project_first_seetype_day_base(
...
is_first_see_project                 string        COMMENT '订单-楼盘首复访类型', 
...
subscribe_contains_cancel_ext_income decimal(19,4) COMMENT '认购佣金-含退、含外联收入', 
...
emp_city_see_project_num             int           COMMENT '带看楼盘量按咨询师统计',
emp_city_subscribe_contains_cancel_ext_num   int           COMMENT '认购量:含退 含外联按咨询师统计',
emp_city_subscribe_contains_cancel_ext_income   int           COMMENT '认购佣金-含退、含外联收入按咨询师统计',
etl_time string COMMENT 'ETL跑数时间')
COMMENT '日-咨询师-城市-楼盘-首复访报表'
stored as parquet;



drop table if exists julive_app.app_emp_city_project_first_seetype_day;
create table julive_app.app_emp_city_project_first_seetype_day like julive_app.app_emp_city_project_first_seetype_day_base;

drop table if exists julive_app.app_wlmq_emp_city_project_first_seetype_day;
create table  julive_app.app_wlmq_emp_city_project_first_seetype_day like julive_app.app_emp_city_project_first_seetype_day_base;

drop table if exists julive_app.app_esf_emp_city_project_first_seetype_day;
create table  julive_app.app_esf_emp_city_project_first_seetype_day like julive_app.app_emp_city_project_first_seetype_day_base;

drop table if exists julive_app.app_jms_emp_city_project_first_seetype_day;
create table  julive_app.app_jms_emp_city_project_first_seetype_day like julive_app.app_emp_city_project_first_seetype_day_base;
