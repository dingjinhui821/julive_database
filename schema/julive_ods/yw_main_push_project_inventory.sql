drop table if exists ods.yw_main_push_project_inventory;
create external table ods.yw_main_push_project_inventory(
id                                                     bigint          comment '',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/yw_main_push_project_inventory'
;
