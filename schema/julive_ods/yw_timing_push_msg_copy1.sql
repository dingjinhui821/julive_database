drop table if exists julive_bak.yw_timing_push_msg_copy1;
create external table julive_bak.yw_timing_push_msg_copy1(
id                                                     int             comment 'id',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/julive_bak/yw_timing_push_msg_copy1'
;
