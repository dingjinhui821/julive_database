drop table if exists ods.ex_order_history;
create external table ods.ex_order_history(
id                                                     int             comment 'id',
...
partner_name                                           string          comment '合作名称，逗号分隔',
...
item_json                                              string          comment 'bd单项目信息（ex_order_item表的信息）',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/ex_order_history'
;
