drop table if exists ods.hj_keyword_adjust_baidu_negative;
create external table ods.hj_keyword_adjust_baidu_negative(
id                                                     int             comment 'id',
...
adjust_object                                          int             comment '调整对象(1计划否，2单元否)',
adjust_negative_type                                   int             comment '调整类型(11计划短否，12计划精否 21单元短否，22单元精否)',
adjust_object_id                                       bigint          comment '目标对象id',
adjust_object_name                                     string          comment '目标对象名',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/hj_keyword_adjust_baidu_negative'
;
