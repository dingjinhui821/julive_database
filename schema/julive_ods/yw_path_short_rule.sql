drop table if exists ods.yw_path_short_rule;
create external table ods.yw_path_short_rule(
id                                                     int             comment '',
city_id                                                int             comment '',
distribute_type                                        int             comment '分配类型（1-路径缩短 2.优选客户）',
pc_m_port                                              string          comment '',
app_port                                               string          comment '',
is_merit                                               int             comment '是否择优:1是2否',
alloc_channel                                          string          comment '',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/yw_path_short_rule'
;
