drop table if exists julive_bak.yw_operation_log_copy_clean_20190728_bf;
create external table julive_bak.yw_operation_log_copy_clean_20190728_bf(
...
lines terminated by '\n' 
stored as textfile  
location '/dw/julive_bak/yw_operation_log_copy_clean_20190728_bf'
;
