drop table if exists julive_bak.yw_dingding_msg_send_copy_clean;
create external table julive_bak.yw_dingding_msg_send_copy_clean(
...
lines terminated by '\n' 
stored as textfile  
location '/dw/julive_bak/yw_dingding_msg_send_copy_clean'
;
