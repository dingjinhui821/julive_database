drop table if exists ods.dsp_account_structure_shenma;
create external table ods.dsp_account_structure_shenma(
id                                                     int             comment 'id',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/dsp_account_structure_shenma'
;
