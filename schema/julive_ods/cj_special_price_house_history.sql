drop table if exists ods.cj_special_price_house_history;
create external table ods.cj_special_price_house_history(
id                                                     int             comment '',
...
special_price_house_id                                 int             comment '特价房源主表id',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/cj_special_price_house_history'
;
