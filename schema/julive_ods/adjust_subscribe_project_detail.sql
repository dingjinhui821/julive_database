drop table if exists ods.adjust_subscribe_project_detail;
create external table ods.adjust_subscribe_project_detail(
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/adjust_subscribe_project_detail'
;
