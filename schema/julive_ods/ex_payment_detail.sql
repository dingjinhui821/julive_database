drop table if exists ods.ex_payment_detail;
create external table ods.ex_payment_detail(
id                                                     bigint          comment '',
...
review                                                 int             comment '审核状态，0未审核，1审核成功，2审核失败 3审批通过撤销',
...
is_old                                                 int             comment '是否是老数据0:否 1:是 2:2018/01/04处理的错误老数据',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/ex_payment_detail'
;
