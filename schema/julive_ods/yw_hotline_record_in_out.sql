drop table if exists ods.yw_hotline_record_in_out;
create external table ods.yw_hotline_record_in_out(
id                                                     bigint          comment '',
...
call_type                                              int             comment '呼叫类型:1:呼入 3:呼出',
...
end_type                                               int             comment '0: 未知11用户挂断,12坐席挂断 13转接',
satisfy_code                                           int             comment '1=满意2=服务态度差3=造成打扰4=未解答问题-1:用户挂机-2:超时未评价-3:未评价挂机-4:坐席挂机',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/yw_hotline_record_in_out'
;
