drop table if exists ods.yw_deal_payment_total_history_cal;
create external table ods.yw_deal_payment_total_history_cal(
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/yw_deal_payment_total_history_cal'
;
