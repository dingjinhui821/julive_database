drop table if exists ods.cj_case_field;
create external table ods.cj_case_field(
id                                                     bigint          comment '',
project_id                                             int             comment '楼盘id',
statistics_datetime                                    int             comment '统计时间',
visit_num                                              double          comment '到访总量',
paihao_num                                             double          comment '排号总量',
subscribe_num                                          double          comment '认购总量',
