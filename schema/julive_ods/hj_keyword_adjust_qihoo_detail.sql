drop table if exists ods.hj_keyword_adjust_qihoo_detail;
create external table ods.hj_keyword_adjust_qihoo_detail(
id                                                     int             comment 'id',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/hj_keyword_adjust_qihoo_detail'
;
