drop table if exists ods.cj_project_building_info_history;
create external table ods.cj_project_building_info_history(
id                                                     bigint          comment '',
cj_project_building_info_id                            bigint          comment '楼盘共用信息表id',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/cj_project_building_info_history'
;
