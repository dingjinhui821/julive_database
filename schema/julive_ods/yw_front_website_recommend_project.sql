drop table if exists ods.yw_front_website_recommend_project;
create external table ods.yw_front_website_recommend_project(
id                                                     int             comment '',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/yw_front_website_recommend_project'
;
