drop table if exists ods.dsp_account_structure_qihoo_tmp;
create external table ods.dsp_account_structure_qihoo_tmp(
id                                                     int             comment '',
...
lines terminated by '\n' 
stored as textfile  
location '/dw/ods/dsp_account_structure_qihoo_tmp'
;
