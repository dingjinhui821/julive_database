drop table if exists julive_fact.fact_city_channel_day_agg_base_indi;
CREATE TABLE julive_fact.fact_city_channel_day_agg_base_indi(
...
emp_city_see_num                                    int           COMMENT '员工所在城市带看量', 
emp_city_see_project_num                            int           COMMENT '员工所在城市带看楼盘量',
...
emp_city_subscribe_contains_cancel_ext_num          int           COMMENT '员工所在城市认购量-含退、含外联', 
emp_city_subscribe_contains_cancel_ext_amt          decimal(19,4) COMMENT '员工所在城市认购-含退、含外联GMV', 
emp_city_subscribe_contains_cancel_ext_income       decimal(19,4) COMMENT '员工所在城市认购-含退、含外联收入', 
emp_city_subscribe_contains_cancel_ext_project_num  int           COMMENT '员工所在城市认购楼盘量-含退、含外联(月破蛋楼盘数)', 
emp_city_subscribe_contains_ext_amt                 decimal(19,4) COMMENT '员工所在城市认购-含外联GMV', 
emp_city_subscribe_contains_ext_income              decimal(19,4) COMMENT '员工所在城市认购-含外联收入',

subscribe_cancel_contains_ext_amt                   decimal(19,4) COMMENT '退认购金额-含外联',
emp_city_subscribe_cancel_contains_ext_amt          decimal(19,4) COMMENT '员工所在城市退认购金额-含外联',  
...
drop table if exists julive_fact.fact_wlmq_city_channel_day_agg_indi;
create external table julive_fact.fact_wlmq_city_channel_day_agg_indi
like julive_fact.fact_city_channel_day_agg_base_indi;

drop table if exists julive_fact.fact_city_channel_day_agg_indi;
create external table julive_fact.fact_city_channel_day_agg_indi
like julive_fact.fact_city_channel_day_agg_base_indi;

drop table if exists julive_fact.fact_esf_city_channel_day_agg_indi;
create external table julive_fact.fact_esf_city_channel_day_agg_indi
like julive_fact.fact_city_channel_day_agg_base_indi;

drop table if exists julive_fact.fact_jms_city_channel_day_agg_indi;
create external table julive_fact.fact_jms_city_channel_day_agg_indi
like julive_fact.fact_city_channel_day_agg_base_indi;
