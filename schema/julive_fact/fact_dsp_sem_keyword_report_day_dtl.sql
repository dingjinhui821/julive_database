drop TABLE if exists julive_fact.fact_dsp_sem_keyword_report_day_dtl;
CREATE EXTERNAL TABLE julive_fact.fact_dsp_sem_keyword_report_day_dtl(
...
url                  string        COMMENT '关键词投放URL：总有一天我会删掉的', 
...
average_ranking      string        COMMENT '平均排名', 
price                decimal(15,4) COMMENT '出价', 
etl_time             string        COMMENT 'etl跑数时间')
COMMENT 'DSP-SEM关键词报告明细事实表'
PARTITIONED BY ( 
