drop table if exists tmp_etl.tmp_event_hour_dtl;
CREATE EXTERNAL TABLE `tmp_etl.tmp_event_hour_dtl`(
...
LOCATION
  'hdfs://optimuspro01:8020/dw/tmp_etl/tmp_event_hour_dtl'
TBLPROPERTIES (
  'transient_lastDdlTime'='1582120609');
