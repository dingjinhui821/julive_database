drop table if exists julive_fact.fact_subscribe_sign_payment_indi;
CREATE EXTERNAL TABLE julive_fact.fact_subscribe_sign_payment_indi(
...
region                      string        COMMENT '楼盘地理城市大区',
...
sign_audit_status           int           COMMENT '签约有效性：0未审核 1有效 2无效 3待定', 
