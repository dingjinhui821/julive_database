drop table if exists julive_fact.fact_psft_city_satisfaction_indi;
CREATE EXTERNAL TABLE julive_fact.fact_psft_city_satisfaction_indi(
...
LOCATION
  'hdfs://optimuspro01:8020/dw/julive_fact/fact_psft_city_satisfaction_indi'
TBLPROPERTIES (
  'transient_lastDdlTime'='1572439293')
