drop table if exists julive_fact.fact_zxs_adjust_cust_subscribe_base_dtl;
CREATE TABLE julive_fact.fact_zxs_adjust_cust_subscribe_base_dtl(
...
drop table if exists julive_fact.fact_wlmq_zxs_adjust_cust_subscribe_dtl;
create external table julive_fact.fact_wlmq_zxs_adjust_cust_subscribe_dtl
like julive_fact.fact_zxs_adjust_cust_subscribe_base_dtl;
drop table if exists julive_fact.fact_zxs_adjust_cust_subscribe_dtl;
create external table julive_fact.fact_zxs_adjust_cust_subscribe_dtl
like julive_fact.fact_zxs_adjust_cust_subscribe_base_dtl;
drop table if exists julive_fact.fact_esf_zxs_adjust_cust_subscribe_dtl;
create external table julive_fact.fact_esf_zxs_adjust_cust_subscribe_dtl
like julive_fact.fact_zxs_adjust_cust_subscribe_base_dtl;
drop table if exists julive_fact.fact_jms_zxs_adjust_cust_subscribe_dtl;
create external table julive_fact.fact_jms_zxs_adjust_cust_subscribe_dtl
like julive_fact.fact_zxs_adjust_cust_subscribe_base_dtl;
