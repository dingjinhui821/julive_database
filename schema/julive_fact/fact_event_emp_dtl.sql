CREATE EXTERNAL TABLE `julive_fact.fact_event_emp_dtl`(
...
PARTITIONED BY ( 
  ...
  `pplatform` string COMMENT '产品端分区:201 支撑系统 | 202 咨询师app | 203 咨询师pad')
ROW FORMAT SERDE 
...
LOCATION
  'hdfs://optimuspro01:8020/dw/julive_fact/fact_event_emp_dtl'
TBLPROPERTIES (
  'transient_lastDdlTime'='1572926223')
