CREATE EXTERNAL TABLE `julive_fact.fact_subscribe_no_sign_nowsign_indi`(
  ...
  `pdate` string COMMENT '分区时间', 
  `sign_id` bigint COMMENT '签约id', 
  `sign_date` string COMMENT '签约时间', 
  `etl_time` string COMMENT 'ETL跑数时间')
COMMENT '认购未签约全量表 历史未签约单均匹配最新的签约状态'
ROW FORMAT SERDE 
...
LOCATION
  'hdfs://optimuspro01:8020/dw/julive_fact/fact_subscribe_no_sign_nowsign_indi'
TBLPROPERTIES (
  'COLUMN_STATS_ACCURATE'='true', 
  'numFiles'='9', 
  'numRows'='735717', 
  'rawDataSize'='28692963', 
  'totalSize'='33113472', 
  'transient_lastDdlTime'='1590545671')
