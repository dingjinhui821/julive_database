...
用户行为->用户评分->划分周期
新生期      未上户 近三十天活跃 评分<=6
成长期      未上户 近三十天活跃 评分>6<=14
活跃期      未上户 近三十天活跃 评分>14
成熟期      上户   近三十天活跃 未认购  评分<=19.5
成熟期高质量 上户   近三十天活跃 未认购  评分>19.5
衰退期      上户   近三十天未活跃 未认购 评分<=19.5
衰退期高质量 上户   近三十天未活跃 未认购 评分>19.5
结束期      已认购
其他        未上户近三十天未活跃


drop table if exists julive_topic.topic_lable_user_lifecycle_pcm_rating;
create table julive_topic.topic_lable_user_lifecycle_pcm_rating(
