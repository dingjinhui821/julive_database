...
drop table if exists julive_topic.topic_dws_order_city_base;
create table if not exists julive_topic.topic_dws_order_city_base(
clue_id                               bigint          comment '线索ID',
city_id                               int             comment '城市ID 线索/上户：意向城市 其它：EMP_CITY_ID',
